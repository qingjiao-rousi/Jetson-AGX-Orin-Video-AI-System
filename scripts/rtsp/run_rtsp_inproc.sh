...
Purpose:
  ...
  with one nvstreammux. Use scripts/rtsp/serve_mp4_as_rtsp.py first when you only
...
Examples:
  python3 scripts/rtsp/serve_mp4_as_rtsp.py "$VIDEO_DIR" --limit 8

  scripts/rtsp/run_rtsp_inproc.sh "$OUTPUT_ROOT/rtsp_inproc"
USAGE
}

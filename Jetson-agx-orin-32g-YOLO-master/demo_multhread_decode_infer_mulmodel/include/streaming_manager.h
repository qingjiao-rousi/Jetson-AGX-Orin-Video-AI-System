...
struct StreamingData
{
    ...
    std::chrono::system_clock::time_point timestamp; // 视频帧时间戳
};
...
private:
    ...
    // RTMP推流相关
    bool initializeRTMP();                    // MPP编码
    bool sendRTMPFrame(const cv::Mat &frame); // ffmpeg封装推流
...
private:
    ...
    std::condition_variable queue_cv_; // 有新帧通知推流线程
